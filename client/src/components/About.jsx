  ...
  return (
    <section className="about" id="about">
        <div className="about_content container">
            ...
            On the frontend, I excel in using technologies such as HTML5, CSS3, and JavaScript, along with modern frameworks like React.js. My approach is always to create intuitive and engaging interfaces that enhance the user experience.

            On the backend, I`ve worked with technologies such as Node.js and Python, using frameworks like Express and Django to build robust and scalable services. Additionally, I have experience in designing efficient databases and implementing RESTful APIs.</p>
        </div>
    </section>
  )
}
